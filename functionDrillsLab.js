...
console.log(exclaimThree("DevMountain"))
...
/*
  ...
  If the passed in color equals 'green', return c
...
//CODE HERE
const bestMovie = (par) => `${par} is the best movie ever`
...
const emailCheck = (email) => {
  ...
  modifiedEmail = stremail.trim()
 
 
  if (modifiedEmail.includes('@')){
...
console.log(emailCheck("  gizemce00gmail.com  "))
////////////////// PROBLEM 19 ////////////////////
/*
...
//CODE HERE
const frog = (amountOfGold) => {
  amountOfChoco = amountOfGold / 3
  return parseInt(amountOfChoco)
}
var totalFrogs = frog(4)
...
var totalFrogs2 = frog(4)
console.log(totalFrogs2)

////////////////// PROBLEM 21 ////////////////////
let sampleArray = [0,1,2,3,10,5,6,8,9]
/*
...
var arrayIsAscending = argument(sampleArray)
